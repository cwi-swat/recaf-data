...
syntax BeforeStaticMethod
  = Anno
  | StaticMethodMod
  ;

syntax StaticMethodMod =
  "public" 
  ;
  
syntax StaticMethodDec = StaticMethodDecHead MethodBody;
  
syntax StaticMethodDecHead =
 	staticMethodDec: BeforeDefaultMethod* "static" TypeParams? ResultType Id "(" {FormalParam ","}* ")" Throws?;

  
syntax BeforeDefaultMethod
  = Anno
  | DefaultMethodMod
  ;

syntax DefaultMethodMod =
  "public" 
  ;
  
syntax DefaultMethodDec = DefaultMethodDecHead MethodBody;
  
syntax DefaultMethodDecHead =
 	defaultMethodDec: BeforeDefaultMethod* "default" TypeParams? ResultType Id "(" {FormalParam ","}* ")" Throws?;
