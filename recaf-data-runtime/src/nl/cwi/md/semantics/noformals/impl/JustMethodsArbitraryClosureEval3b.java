...
import nl.cwi.md.semantics.noformals.alg.JustMethodsArbitraryClosure3b;

public class JustMethodsArbitraryClosureEval3b<T> implements
		JustMethodsArbitraryClosure3b<T, Map<String, BiFunction<T, Object[], Object>>, Pair<String, BiFunction<T, Object[], Object>>> {
	...
	@Override
	public Pair<String, BiFunction<T, Object[], Object>> Method(String name, Closure body) {
