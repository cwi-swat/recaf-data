...
import nl.cwi.md.semantics.oominheritance.alg.BaseMInheritance2;
import nl.cwi.md.semantics.oominheritance.ast.Body;
import nl.cwi.md.semantics.oominheritance.ast.Interface2;
import nl.cwi.md.semantics.oominheritance.ast.MMethod;
import nl.cwi.md.semantics.oominheritance.ast.Member;

public class BaseMInheritanceImpl2<T> implements BaseMInheritance2<T, Body<T>, Member<T>, Formal> {

	@SuppressWarnings("unchecked")
	@Override
	public T Interface(Class<T> iface, Class<?>[] parentIfaces, T self, Body<T> body,
			Object... args) {
		return new Interface2<T>(iface, parentIfaces, self, body, args).getProxy();
	}
